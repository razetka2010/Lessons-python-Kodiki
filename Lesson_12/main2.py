...
quiz = [
    {"text": "245 + 187",
     "options": ["422", "432", "423", "442"],
      "answer": 1},
    {"text": "500 - 278",
      "options": ["222", "232","322", "223"],
      "answer": 0},
    {"text": "48 × 6",
      "options": ["284", "288", "248", "268"],
      "answer": 1},
      {"text": "Найдите значение выражения: 15 + 6 × 4",
      "options": ["84", "39", "44", "54"],
      "answer": 1},
      {"text": "315 : 7",
      "options": ["44", "35", "55", "45"],
      ...
      "answer": 0},
      {"text": "3,26 + 1,84",
      "options": ["4,10", "5,00", "5,10", "4,90"],
      "answer": 2},
      {"text": "7,5 * 0,4",
      "options": ["3,0", "3,2", "2,8", "30,0"],
      "answer": 0},
]
...
label = Label(text="Игра викторина", font=("Arial", 20, "bold"), bg="#65b8aa", fg="#ffffff")
label.pack(pady=8)
